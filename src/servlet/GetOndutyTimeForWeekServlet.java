 ...
 */
@WebServlet("/getDutyTimeForWeek.do")
public class GetOndutyTimeForWeekServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetOndutyTimeForWeekServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String allTime = signDB.getAllTimeForWeekByNum(studentNum);
		signDB.close();
